...
import space.beka.yolharakatqoidalari.adapters.CategoryAdapter
import space.beka.yolharakatqoidalari.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        TabLayoutMediator(binding.tabLayout, binding.viewPager
            ...
            tabView.tab_item.setImageResource(tabList[position])
